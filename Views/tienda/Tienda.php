						...
						<div class="filter-col4 p-b-27">
							...
							<div class="flex-w p-t-4 m-r--5">
								<?php 
								 ...
								 ?>
								<a href="<?= base_url() ?>/tienda/categoria/<?= $categoria['id_categoria'].'/'.$categoria['ruta'] ?>" class="flex-c-m stext-107 cl6 size-301 bor7 p-lr-15 hov-tag1 trans-04 m-r-5 m-b-5">
									<?= $categoria['Nombre_producto'] ?> <span> &nbsp;(<?= $categoria['cantidad'] ?>)</span>
								</a>
								<?php 
										}
									}
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="#"
								 id="<?= openssl_encrypt($arrProductos[$p]['id_producto'],METHODENCRIPT,KEY); ?>"
