	...
	<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar">
						Bienvenidos a la Clinica Veterinaria
					</div>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="<?= media() ?>/tienda/images/icons/logo-01.png" alt="Logo Clinica">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="<?= media() ?>/tienda/images/icons/logo-01.png" alt="Logo veterinaria"></a>
			</div>
